...
export default function StudentForm({ student, onSubmit, onClose }: StudentFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const studentData: Partial<Student> = {
      ...
      physicalTests: formData.physicalTests,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto`}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
          ...
          {/* Unit Selection */}
          <section>
            <h3 className={`text-lg font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} mb-4`}>Unidade</h3>
          ...
          <section>
            <h3 className={`text-lg font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} mb-4`}>
          ...
          {/* Form Actions */}
          <div className={`sticky bottom-0 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} pt-4 border-t`}>
